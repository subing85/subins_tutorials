...
class Window(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None, mode=None):  
        ...
        self.subfield = self.pub.valid_modes[self.mode]['subfield'][4]
        self.types = self.pub.valid_modes[self.mode]['type'][1]
        self.valid_subfields = self.pub.valid_modes[self.mode]['subfield'][0:4]
    ...
    def set_default(self):
        ...
        type_data = self.pub.get_type_caption()        
        captions = [''] + type_data[self.types]
    ...
    def load_current_caption(self, caption):        
        self.caption_data = self.pub.get_subfields(caption)
        ...
        for subfield in self.valid_subfields:
            ...
            for each in versions:
                version_item = widgets.add_treewidget_item(
    ...
    def add_to_composition(self, from_widget, to_widget):
        ...
        for item in current_items:
            ...
            if subfield in exists_subfields:
                ...
                subfield_item = widgets.add_treewidget_item(to_widget, subfield, icon=subfield)
            version_item = widgets.add_treewidget_item(subfield_item, item.text(0), icon='version')
    ...
    def get_widget_data(self):        
        caption = self.combobox_caption.currentText()
        tag = self.pub.get_caption_tag(caption)
        widgets = {
            'caption': caption,
    ...
    def publish(self):
        ...
        self.pub.bundle['source_file'] = None
