...
class Window(QtWidgets.QWidget):
    ...
    def setup_ui(self):  
        self.setObjectName('widget_layout_pull')
        ...
        self.gridlayout.addWidget(self.combobox_tag, 1, 1, 1, 2)
        self.combobox_tag.currentIndexChanged.connect(self.set_current_tag)
        
        self.label_assets = QtWidgets.QLabel(self)
        self.label_assets.setObjectName('label_assets')
        self.label_assets.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_assets.setText('assets')
        ...
        self.treewidget.currentItemChanged.connect(self.current_asset_select)        
        ...
        self.button_build = QtWidgets.QPushButton(self)
        self.button_build.setObjectName('button_build')
        self.button_build.setText('build')
                
        self.horizontallayout_button.addWidget(self.button_build)
