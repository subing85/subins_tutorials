...
class Window(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        self.setObjectName('widget_shot_push')
        ...
        self.label_dependency.setText('Available Dependencies')
        self.label_dependency.setAlignment(QtCore.Qt.AlignRight | QtCore.Qt.AlignVCenter)
        self.label_dependency.setEnabled(False)
        ...
        self.combobox_dependency.setEnabled(False)
    ...
    def set_current_version(self):
        ...
        if caption:        
            type, tag = caption.split('|')        
            self.combobox_type.setCurrentText(type)
            self.combobox_tag.setCurrentText(tag)
            self.combobox_dependency.setCurrentText('None')
        self.combobox_type.setEnabled(False)
        self.combobox_tag.setEnabled(False)
        self.combobox_dependency.setEnabled(False)        
