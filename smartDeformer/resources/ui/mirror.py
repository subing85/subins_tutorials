...
class Mirror(QtGui.QWidget):
    ...
    def setupUi(self):
        ...
        for each_mirror in mirrors:
            ...
            self.button_mirror.clicked.connect(
                partial(self.setMirrorFlip, each_mirror.lower(), 'mirror', radiobuttons))
            self.button_flip.clicked.connect(
                partial(self.setMirrorFlip, each_mirror.lower(), 'flip', radiobuttons))
            ...
            spacerItem = QtGui.QSpacerItem(
                20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
    ...
    def setMirrorFlip(self, tag, type, radiobuttons):
