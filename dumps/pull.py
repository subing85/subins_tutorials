...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem = QtGui.QSpacerItem(100, 10, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontallayout_bar.addItem(spacerItem)
        self.lineEdit_2 = QtGui.QLineEdit(self.groupbox_bar)
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.horizontallayout_bar.addWidget(self.lineEdit_2)
