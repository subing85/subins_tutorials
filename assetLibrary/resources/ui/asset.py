...
class Asset(QtGui.QWidget):
    ...
    def setup_ui(self):
        ...
        self.label_filepath.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)        
        ...
        self.label_imagepath.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)       
