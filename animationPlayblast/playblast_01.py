...
def createMovie(camera=None):
    # Set the camera
    currentCamera = camera or 'Animation_CameraShape'
...
if __name__ == '__main__':
    ...
    if replay == 'Yes':
        createMovie(camera='Animation_CameraShape')
    else:
        print 'Abort your process'
