...
class Preference(QtGui.QWidget):
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        if 'child' in kwargs:        
            self.library_window = kwargs['child']
    ...
    def setup_ui(self):
        ...
        self.setWindowTitle('Preferences ({} {})'.format(self.lable, self.version))        
        self.resize(700, 100)
    ...
    def create_preference(self):
        comment = '{} {} - preference container'.format(self.lable, self.version)
    ...
    def find_path(self, widgets):
        path = QtGui.QFileDialog.getExistingDirectory(self, 'Browser', self.brows_directory)        
        if not path:
            return
