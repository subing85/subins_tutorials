...
class Catalogue(QtGui.QWidget):
    ...
    def setup_ui(self):
        ...
        self.treewidget_folder.setSelectionMode(QtGui.QAbstractItemView.ExtendedSelection)
        ...
        self.listWidget_catalogue.setIconSize(QtCore.QSize(self.currnet_size[0], self.currnet_size[1]))
    ...
    def zoom(self, widget, ingrement):
        zoom_size = [self.currnet_size[0] + ingrement, self.currnet_size[1] + ingrement]        
        self.listWidget_catalogue.setIconSize(QtCore.QSize(zoom_size[0], zoom_size[1])) 
        
        
# print help(QtGui.QKeyEvent)
