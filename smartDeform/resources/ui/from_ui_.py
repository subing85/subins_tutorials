...
#
# Created: Sat Dec 29 21:06:17 2018
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 586, 366))
        ...
        self.listWidget_clusterWeight.addItem(item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        __sortingEnabled = self.listWidget_clusterWeight.isSortingEnabled()
        self.listWidget_clusterWeight.setSortingEnabled(False)
        item = self.listWidget_clusterWeight.item(0)
        item.setText(_translate("MainWindow", "SUbin", None))
        self.listWidget_clusterWeight.setSortingEnabled(__sortingEnabled)
